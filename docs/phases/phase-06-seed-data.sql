...
--
-- Add additional workspaces below as your tenancy needs grow. Both inserts
-- use ON CONFLICT … DO NOTHING so re-running the script is a no-op.

insert into public.workspaces (id, name, slug, description, created_by, created_at, updated_at)
values (
  '10000000-0000-4000-a000-000000000001',
  'Cape Town Church',
  'cpt',
  'Philip Southern Africa HQ.',
  null,
  now(),
  now()
)
...
insert into public.workspace_roles
  (workspace_id, name, can_create, can_read, can_update, can_delete, can_manage_roles, is_system)
values
